...
const SkillsScreen = () => {
  ...
  return (
    <div style={{marginLeft:"20px", marginTop:"20px"}}>
        <div style={{ marginLeft: '150px', fontSize: '28px', fontWeight: 'bold'}}>
            <a>My Skills </a>
            <a style={{marginLeft:"580px"}}>My Experience</a>
        </div>
        ...
        <div style={{ marginLeft: "300px", fontFamily: "Arial, sans-serif" }}>
            ...
            <div style={{ borderBottom: "2px solid #333", paddingBottom: "10px", marginBottom: "30px" }}>
                ...
                <a style={{marginTop:"10px", marginLeft:"150px", fontSize: '28px', fontWeight: 'bold'}}>Education</a>
